        ...
        if (checkData(data)) {
            try {
                ...
                const response = await fetch('https://localhost:7075/api/customer-receipts', {
                    ...
                    credentials: 'include',
                    body: JSON.stringify({customerId: data.customerId, dateOfOrder: data.dateOrder, details: list})
                })
                if (!response.ok) {
                    const content = await response.json();
    ...
    return (
        <div className="d-flex justify-content-center flex-column pt-3 p-5 w-100 ">
            <form className="w-100 d-flex justify-content-center flex-column"
                ...
                <p className="h1 page-header text-center mb-3">Tạo hóa đơn mua hàng </p>
                <div className="d-flex flex-column">
                    <div className="row">
                        ...
                        <div className="col-6">
                            <div className="form-floating mb-3">
                                <input type={"date"} defaultValue={date} className="form-control rounded-0 border-2"
            ...
            <div>
                {!addMode ?
                    <div>
                        <button type={"button"} className="btn btn-primary rounded-0 border-3 fw-bold mb-3 w-25"
                    ...
                    :
                    <div>
                        <button className="btn btn-secondary rounded-0 border-3 fw-bold w-25"
                        ...
                        <div className="d-flex pt-3 pb-3 gap-5">
                            ...
                            <div className="d-flex justify-content-center w-25">
                                <button className="btn btn-success rounded-0 border-3 fw-bold m-auto w-100"
